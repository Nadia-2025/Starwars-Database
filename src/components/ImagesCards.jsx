const ImagesCards = ({ uid, type }) => {
  const images = {
    ...
    vehicles: [
      { uid: 4, image: "/vehicles/Sand-Crawler.jpeg" },
      { uid: 7, image: "/vehicles/x-34 landspeeder.jpg" },
      { uid: 6, image: "/vehicles/t-16 skyhopper.jpg" },
      { uid: 8, image: "/vehicles/starfighter.jpg" },
      { uid: 14, image: "/vehicles/snowspeeder.jpg" },
      { uid: 18, image: "/vehicles/at-at.jpg" },
      { uid: 16, image: "/vehicles/tie-bomber.jpg" },
      { uid: 19, image: "/vehicles/at-st.jpg" },
      { uid: 20, image: "/vehicles/storm-iv.jpg" },
      { uid: 24, image: "/vehicles/sail-barge.png" },
    ],
  };
